...
- Upstream: Eclipse Mosquitto 2.1.2 — EPL-2.0 OR BSD-3-Clause
  - Source: https://github.com/eclipse-mosquitto/mosquitto/tree/v2.1.2
  - Licence: https://github.com/eclipse-mosquitto/mosquitto/blob/v2.1.2/LICENSE.txt
  - Notice: https://github.com/eclipse-mosquitto/mosquitto/blob/v2.1.2/NOTICE.md
- Container: Docker Official Image `eclipse-mosquitto:2.1.2-alpine`
  - Multi-architecture index digest: `sha256:6f8d8a947c506f8a2290ec65cd4bd2bc7cb4d43fb5f6271f861cb013e2ef9797`
  - Image documentation: https://hub.docker.com/_/eclipse-mosquitto
...
The recipe runs an unmodified Docker Official Image. Corresponding source is
